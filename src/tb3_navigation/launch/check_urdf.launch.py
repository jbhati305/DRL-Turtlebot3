...
def generate_launch_description():
    ...
    pkg_tb3_navigation = FindPackageShare('tb3_navigation')
    default_rviz_config_path = PathJoinSubstitution([pkg_tb3_navigation, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the tb3_navigation package
