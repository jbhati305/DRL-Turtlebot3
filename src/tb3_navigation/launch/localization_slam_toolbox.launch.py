...
def generate_launch_description():
    ...
    pkg_tb3_navigation = get_package_share_directory('tb3_navigation')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_tb3_navigation)
    ...
    slam_toolbox_params_path = os.path.join(
        get_package_share_directory('tb3_navigation'),
        'config',
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_tb3_navigation, 'rviz', LaunchConfiguration('rviz_config')])],
