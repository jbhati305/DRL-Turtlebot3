...
def generate_launch_description():
    ...
    pkg_tb3_simulation = FindPackageShare('tb3_simulation')
    default_rviz_config_path = PathJoinSubstitution([pkg_tb3_simulation, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the tb3_simulation package
